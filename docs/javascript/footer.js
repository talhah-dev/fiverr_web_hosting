 ...
 <footer
        ...
        <div data-aos="fade-up" class="md:col-span-2 md:pr-16">
            ...
            <form action="" class="mt-5 flex flex-col items-end gap-3">
                <input type="text" class="border border-zinc-400 w-full rounded-full p-3"
                    placeholder="Enter email address for updates ">
                <button class="cursor-pointer text-zinc-700 transition-all duration-500 hover:opacity-80">Subscribe</button>
            </form>
        </div>
